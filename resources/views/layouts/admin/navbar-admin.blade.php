<!-- Topnav -->
<nav class="navbar navbar-top navbar-expand navbar-dark bg-theme border-bottom">
                            ...
                            <a href="#!" class="list-group-item list-group-item-action">
                                <div class="row align-items-center">
                                    ...
                                    <div class="col ml--2">
                                        ...
                                        <p class="text-sm mb-0">Selamat Datang di Panel Manajemen Data Otaku
                                            Store</p>
                                    </div>
                                </div>
                            </a>
            ...
            <ul class="navbar-nav align-items-center ml-auto ml-md-0">
                <li class="nav-item dropdown">
                    ...
                    <div class="dropdown-menu dropdown-menu-right">
                        ...
                        <a href="{{ route('index.user') }}" class="dropdown-item">
